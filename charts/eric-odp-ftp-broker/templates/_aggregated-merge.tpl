...
*/ -}}
{{- define "eric-odp-ftp-broker.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-odp-ftp-broker.mergeAnnotations" -}}
  {{- include "eric-odp-ftp-broker.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-odp-ftp-broker.mergeLabels" -}}
  {{- include "eric-odp-ftp-broker.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
